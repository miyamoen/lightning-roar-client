...
var _lightning_roar$lightning_roar_client$Api$fetchMyFeed = function (setting) {
	return _lukewestby$elm_http_builder$HttpBuilder$toTask(
		A2(
			_lightning_roar$lightning_roar_client$Api$withDecoder,
...
var _lightning_roar$lightning_roar_client$Worker_Types$Model = F2(
	function (a, b) {
		return {rootPath: a, entries: b};
	});
var _lightning_roar$lightning_roar_client$Worker_Types$AcceptMyFeedResponse = function (a) {
	return {ctor: 'AcceptMyFeedResponse', _0: a};
};
var _lightning_roar$lightning_roar_client$Worker_Types$UpdateFeed = {ctor: 'UpdateFeed'};
var _lightning_roar$lightning_roar_client$Worker_Types$NoOp = {ctor: 'NoOp'};

var _lightning_roar$lightning_roar_client$Worker_Request$myFeedRequest = function (setting) {
	return A2(
		_elm_lang$core$Task$attempt,
		_lightning_roar$lightning_roar_client$Worker_Types$AcceptMyFeedResponse,
		_lightning_roar$lightning_roar_client$Api$fetchMyFeed(setting));
};
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_0: A2(
				...
				_elm_lang$core$Basics$always(_lightning_roar$lightning_roar_client$Worker_Types$UpdateFeed)),
			_1: {ctor: '[]'}
		});
};
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'UpdateFeed':
				return A2(
					_NoRedInk$rocket_update$Rocket_ops['=>'],
					A2(_elm_lang$core$Debug$log, 'dedede', model),
					{
						ctor: '::',
						_0: _lightning_roar$lightning_roar_client$Worker_Request$myFeedRequest(model),
						_1: {ctor: '[]'}
					});
			default:
				if (_p0._0.ctor === 'Ok') {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								entries: A2(_elm_lang$core$Debug$log, 'mya-', _p0._0._0)
							}),
						{ctor: '[]'});
				} else {
					var _p1 = A2(_elm_lang$core$Debug$log, 'error nya', _p0._0._0);
					return A2(
						_NoRedInk$rocket_update$Rocket_ops['=>'],
						model,
						{ctor: '[]'});
...
var _lightning_roar$lightning_roar_client$Worker_Main$init = function (_p2) {
	var _p3 = _p2;
	return A2(
		_NoRedInk$rocket_update$Rocket_ops['=>'],
		{
			rootPath: _p3.rootPath,
			entries: {ctor: '[]'}
		},
		{ctor: '[]'});
};
var _lightning_roar$lightning_roar_client$Worker_Main$main = _elm_lang$core$Platform$programWithFlags(
	{
		init: function (_p4) {
			return _NoRedInk$rocket_update$Rocket$batchInit(
				_lightning_roar$lightning_roar_client$Worker_Main$init(_p4));
		},
		update: function (_p5) {
			return _NoRedInk$rocket_update$Rocket$batchUpdate(
				_lightning_roar$lightning_roar_client$Worker_Main$update(_p5));
		},
