...
var _lightning_roar$lightning_roar_client$Types$Feed = F3(
	function (a, b, c) {
		return {feedId: a, name: b, icon: c};
	});
var _lightning_roar$lightning_roar_client$Types$UserFeedEntry = F7(
	function (a, b, c, d, e, f, g) {
		return {userId: a, feedId: b, entryId: c, title: d, summary: e, link: f, updated: g};
	});

var _lightning_roar$lightning_roar_client$Decoder$userFeedEntry = A3(
				...
				A3(
					...
					A3(
						...
						A3(
							...
							'userId',
							_elm_lang$core$Json_Decode$int,
							_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_lightning_roar$lightning_roar_client$Types$UserFeedEntry))))))));
var _lightning_roar$lightning_roar_client$Decoder$userFeedEntries = _elm_lang$core$Json_Decode$list(_lightning_roar$lightning_roar_client$Decoder$userFeedEntry);
var _lightning_roar$lightning_roar_client$Decoder$feed = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'iconUrl',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		A3(
			...
			'id',
			_elm_lang$core$Json_Decode$int,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_lightning_roar$lightning_roar_client$Types$Feed))));
var _lightning_roar$lightning_roar_client$Decoder$feeds = _elm_lang$core$Json_Decode$list(_lightning_roar$lightning_roar_client$Decoder$feed);
...
var _lightning_roar$lightning_roar_client$Api$withDecoder = F2(
...
var _lightning_roar$lightning_roar_client$Api$withBase = function (builder) {
	return A2(
		...
		_lukewestby$elm_http_builder$HttpBuilder$withCredentials(builder));
};
var _lightning_roar$lightning_roar_client$Api$methodBuilder = F2(
	function (method, url) {
		var _p0 = method;
		switch (_p0.ctor) {
			case 'Get':
				return _lukewestby$elm_http_builder$HttpBuilder$get(url);
			case 'Post':
				return _lukewestby$elm_http_builder$HttpBuilder$post(url);
			case 'Put':
				return _lukewestby$elm_http_builder$HttpBuilder$put(url);
			default:
				return _lukewestby$elm_http_builder$HttpBuilder$delete(url);
		}
	});
var _lightning_roar$lightning_roar_client$Api$request = F3(
	function (_p1, method, paths) {
		var _p2 = _p1;
		return _lightning_roar$lightning_roar_client$Api$withBase(
			A2(
				_lightning_roar$lightning_roar_client$Api$methodBuilder,
				method,
				A2(
					_elm_lang$core$String$join,
					'/',
					{ctor: '::', _0: _p2.rootPath, _1: paths})));
	});
var _lightning_roar$lightning_roar_client$Api$Delete = {ctor: 'Delete'};
var _lightning_roar$lightning_roar_client$Api$Put = {ctor: 'Put'};
var _lightning_roar$lightning_roar_client$Api$Post = {ctor: 'Post'};
var _lightning_roar$lightning_roar_client$Api$Get = {ctor: 'Get'};
var _lightning_roar$lightning_roar_client$Api$fetchAllFeeds = function (setting) {
	return _lukewestby$elm_http_builder$HttpBuilder$toTask(
		A2(
			_lightning_roar$lightning_roar_client$Api$withDecoder,
			_lightning_roar$lightning_roar_client$Decoder$feeds,
			A3(
				_lightning_roar$lightning_roar_client$Api$request,
				setting,
				_lightning_roar$lightning_roar_client$Api$Get,
				{
					ctor: '::',
					_0: 'feeds',
					_1: {ctor: '[]'}
...
var _lightning_roar$lightning_roar_client$Api$fetchIssues = function (setting) {
	return _lukewestby$elm_http_builder$HttpBuilder$toTask(
		A2(
			_lightning_roar$lightning_roar_client$Api$withDecoder,
			_lightning_roar$lightning_roar_client$Decoder$userFeedEntries,
			A3(
				_lightning_roar$lightning_roar_client$Api$request,
				setting,
				_lightning_roar$lightning_roar_client$Api$Get,
...
var _lightning_roar$lightning_roar_client$Worker_Channel$pushMyFeed = _elm_lang$core$Native_Platform.outgoingPort(
	'pushMyFeed',
	function (v) {
		return _elm_lang$core$Native_List.toArray(v).map(
			function (v) {
				return {userId: v.userId, feedId: v.feedId, entryId: v.entryId, title: v.title, summary: v.summary, link: v.link, updated: v.updated};
			});
	});
var _lightning_roar$lightning_roar_client$Worker_Channel$pushAllFeeds = _elm_lang$core$Native_Platform.outgoingPort(
	'pushAllFeeds',
	function (v) {
		return _elm_lang$core$Native_List.toArray(v).map(
			function (v) {
				return {feedId: v.feedId, name: v.name, icon: v.icon};
			});
	});

var _lightning_roar$lightning_roar_client$Worker_Types$Flags = function (a) {
	return {rootPath: a};
};
var _lightning_roar$lightning_roar_client$Worker_Types$Model = F3(
	function (a, b, c) {
		return {rootPath: a, entries: b, feeds: c};
	});
var _lightning_roar$lightning_roar_client$Worker_Types$AcceptFeedsResponse = function (a) {
	return {ctor: 'AcceptFeedsResponse', _0: a};
};
var _lightning_roar$lightning_roar_client$Worker_Types$AcceptEntriesResponse = function (a) {
	return {ctor: 'AcceptEntriesResponse', _0: a};
};
var _lightning_roar$lightning_roar_client$Worker_Types$UpdateFeeds = {ctor: 'UpdateFeeds'};
var _lightning_roar$lightning_roar_client$Worker_Types$UpdateMyFeed = {ctor: 'UpdateMyFeed'};
var _lightning_roar$lightning_roar_client$Worker_Types$NoOp = {ctor: 'NoOp'};

var _lightning_roar$lightning_roar_client$Worker_Request$allFeeds = function (setting) {
	return A2(
		_elm_lang$core$Task$attempt,
		_lightning_roar$lightning_roar_client$Worker_Types$AcceptFeedsResponse,
		_lightning_roar$lightning_roar_client$Api$fetchAllFeeds(setting));
};
var _lightning_roar$lightning_roar_client$Worker_Request$myFeed = function (setting) {
	return A2(
		_elm_lang$core$Task$attempt,
		_lightning_roar$lightning_roar_client$Worker_Types$AcceptEntriesResponse,
		_lightning_roar$lightning_roar_client$Api$fetchIssues(setting));
};

var _lightning_roar$lightning_roar_client$Worker_Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_0: A2(
				...
				_elm_lang$core$Basics$always(_lightning_roar$lightning_roar_client$Worker_Types$UpdateMyFeed)),
			_1: {ctor: '[]'}
		});
};
var _lightning_roar$lightning_roar_client$Worker_Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'NoOp':
			...
			case 'UpdateMyFeed':
				return A2(
					...
					{
						ctor: '::',
						_0: _lightning_roar$lightning_roar_client$Worker_Request$myFeed(model),
						_1: {ctor: '[]'}
					});
			case 'UpdateFeeds':
				return A2(
					...
					{
						ctor: '::',
						_0: _lightning_roar$lightning_roar_client$Worker_Request$allFeeds(model),
						_1: {ctor: '[]'}
					});
			case 'AcceptEntriesResponse':
				if (_p0._0.ctor === 'Ok') {
					var _p1 = _p0._0._0;
					return A2(
						_NoRedInk$rocket_update$Rocket_ops['=>'],
						_elm_lang$core$Native_Utils.update(
							model,
							{
								entries: A2(_elm_lang$core$Debug$log, 'entriesだよ', _p1)
							}),
						{
							ctor: '::',
							_0: _lightning_roar$lightning_roar_client$Worker_Channel$pushMyFeed(_p1),
							_1: {ctor: '[]'}
						});
				} else {
					var _p2 = A2(_elm_lang$core$Debug$log, 'AcceptEntriesResponse error', _p0._0._0);
					return A2(
						_NoRedInk$rocket_update$Rocket_ops['=>'],
						model,
						{ctor: '[]'});
				...
				if (_p0._0.ctor === 'Ok') {
					...
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								feeds: A2(_elm_lang$core$Debug$log, 'feedsだよ', _p3)
							}),
						{
							ctor: '::',
							_0: _lightning_roar$lightning_roar_client$Worker_Channel$pushAllFeeds(_p3),
							_1: {ctor: '[]'}
						});
				} else {
					var _p4 = A2(_elm_lang$core$Debug$log, 'AcceptFeedsResponse error', _p0._0._0);
					return A2(
						_NoRedInk$rocket_update$Rocket_ops['=>'],
						model,
						{ctor: '[]'});
...
var _lightning_roar$lightning_roar_client$Worker_Main$init = function (_p5) {
	var _p6 = _p5;
	var model = {
		rootPath: _p6.rootPath,
		entries: {ctor: '[]'},
		feeds: {ctor: '[]'}
	};
	return A2(
...
var _lightning_roar$lightning_roar_client$Worker_Main$main = _elm_lang$core$Platform$programWithFlags(
	{
		init: function (_p7) {
			return _NoRedInk$rocket_update$Rocket$batchInit(
				_lightning_roar$lightning_roar_client$Worker_Main$init(_p7));
		},
		update: function (_p8) {
			return _NoRedInk$rocket_update$Rocket$batchUpdate(
				_lightning_roar$lightning_roar_client$Worker_Main$update(_p8));
		},
		subscriptions: _lightning_roar$lightning_roar_client$Worker_Main$subscriptions
	})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (rootPath) {
		...
		A2(_elm_lang$core$Json_Decode$field, 'rootPath', _elm_lang$core$Json_Decode$string)));

var Elm = {};
Elm['Worker'] = Elm['Worker'] || {};
Elm['Worker']['Main'] = Elm['Worker']['Main'] || {};
if (typeof _lightning_roar$lightning_roar_client$Worker_Main$main !== 'undefined') {
    _lightning_roar$lightning_roar_client$Worker_Main$main(Elm['Worker']['Main'], 'Worker.Main', undefined);
}
